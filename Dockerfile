...
FROM repository.broadleafcommerce.com:5001/broadleaf/kafka-kraft-base:wolfi-10 AS build-jsa
...
FROM repository.broadleafcommerce.com:5001/broadleaf/kafka-kraft-base:wolfi-10
